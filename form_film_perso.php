...
try {
	$movie = \Jleagle\Imdb\IMDB::retrieve($_GET['Imdb']);
...
//echo "Title:$fil_titre<br>Year:$fil_annee<br>Genre:$monCat<br>Actors:$fil_acteurs<br>Plot:$fil_synopsis<br>$fil_synopsis<br>$fil_affiche";
//exit;
echo "</pre>";
$dsn = 'mysql:dbname=movie_ganderer;host=127.0.0.1;charset=UTF8';
$user = 'root';
$password = '+webForce3';
...
<body>
	<form>
		<h3>faites votre requete</h3>
		<input type="text" method="get" value="" name="Imdb">
	...
	<form action="" method="post">
		...
		<fieldset>
			...
			<tr>
				<td>Description :&nbsp;</td>
				<td><textarea name="fil_description" rows="12" cols="100"><?php echo $fil_synopsis; ?></textarea></td>
			</tr>
			<tr>
